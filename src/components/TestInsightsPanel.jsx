      ...
      {!showStudentCard && (
        <>
          ...
          <div className="grid-2">
            ...
            <div className="card">
              <div className="section-title" style={{ fontSize: 14 }}>{insights?.overallTopper?.stream === 'NEET' ? 'Total number of centre have no MBBS students in this test' : 'Not qualified (overall) — count by centre'}</div>
