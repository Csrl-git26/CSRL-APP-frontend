      ...
      {!showStudentCard && (
        <>
          ...
          <div className="grid-2">
            ...
            <div className="card">
              <div className="section-title" style={{ fontSize: 14 }}>{insights?.overallTopper?.stream === 'NEET' ? 'Total no. of students with empty marks - centrewise' : 'Not qualified (overall) — count by centre'}</div>
