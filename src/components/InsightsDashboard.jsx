...
import {
  ...
  BarChart3, Target, Award, BookOpen, Star, Flag, PieChart as PieChartIcon, Repeat
} from 'lucide-react';
      ...
      <div className="card" style={{ display: 'flex', flexDirection: 'column', height: '100%', justifyContent: 'space-between', backfaceVisibility: 'hidden', padding: 20 }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          ...
          <div 
            ...
            style={{ cursor: 'pointer', padding: 8, borderRadius: '50%', color: '#1d4ed8', background: 'linear-gradient(145deg, #ffffff, #dbeafe)', boxShadow: '4px 4px 8px rgba(186, 203, 245, 0.6), -4px -4px 8px rgba(255, 255, 255, 0.8), inset 1px 1px 2px rgba(255,255,255,1), inset -1px -1px 2px rgba(186, 203, 245, 0.3)', border: '1px solid rgba(255,255,255,0.7)', transition: 'all 0.2s', display: 'flex', alignItems: 'center', justifyContent: 'center' }}
                ...
                const renderCustomTick = (props) => {
                  ...
                  return (
                    <g transform={`translate(${x},${y})`} onClick={() => { if(onViewStudent && studentId) onViewStudent(studentId); }} style={{ cursor: 'pointer' }}>
                      ...
                      <text x={-5} y={-4} textAnchor="end" fill="#1e293b" fontSize={8.5} fontWeight={900} letterSpacing="0.5px">{name} {extra}</text>
                  ...
                  <div style={{ height: 180, width: '100%', marginTop: 8 }}>
                    <ResponsiveContainer width="100%" height={180}>
                      ...
                      >
                        ...
                        <YAxis type="category" dataKey="name" axisLine={false} tickLine={false} tick={renderCustomTick} interval={0} width={110} />
                        ...
                        <Bar shape={(props) => renderStudentBarShape(props, "Botany", title, activeStudentBar)} onMouseEnter={(_, index) => setActiveStudentBar({chartId: title, index, dataKey: "Botany"})} onMouseLeave={() => setActiveStudentBar(null)} dataKey="Botany" stackId="a" fill="#059669" barSize={24} isAnimationActive={shouldAnimate} animationDuration={2000} animationEasing="ease-out" onClick={(data) => onViewStudent && onViewStudent(data.studentId)} style={{ cursor: 'pointer' }}>
                          <LabelList dataKey="Botany_orig" content={(props) => <CustomBarLabel {...props} prefix="Bot" />} />
                        </Bar>
<Bar shape={(props) => renderStudentBarShape(props, "Zoology", title, activeStudentBar)} onMouseEnter={(_, index) => setActiveStudentBar({chartId: title, index, dataKey: "Zoology"})} onMouseLeave={() => setActiveStudentBar(null)} dataKey="Zoology" stackId="a" fill="#0891b2" barSize={24} isAnimationActive={shouldAnimate} animationDuration={2000} animationEasing="ease-out" onClick={(data) => onViewStudent && onViewStudent(data.studentId)} style={{ cursor: 'pointer' }}>
              ...
              <div className="card" style={{ padding: 20, display: 'flex', flexDirection: 'column', height: '100%', justifyContent: 'space-between' }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
                  ...
                  <div 
                    ...
                    style={{ cursor: 'pointer', padding: 8, borderRadius: '50%', color: '#1d4ed8', background: 'linear-gradient(145deg, #ffffff, #dbeafe)', boxShadow: '4px 4px 8px rgba(186, 203, 245, 0.6), -4px -4px 8px rgba(255, 255, 255, 0.8), inset 1px 1px 2px rgba(255,255,255,1), inset -1px -1px 2px rgba(186, 203, 245, 0.3)', border: '1px solid rgba(255,255,255,0.7)', transition: 'all 0.2s', display: 'flex', alignItems: 'center', justifyContent: 'center', marginTop: -4 }}
