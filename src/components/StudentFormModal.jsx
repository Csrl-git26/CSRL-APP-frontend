...
const TEXT_FIELDS = [
  ...
  { key: 'CENTRE CODE',             label: 'Centre Code (Extra)' },
  { key: 'Mode of Selection',       label: 'Mode of Selection' },
  { key: 'Written Test Marks (240)',label: 'Written Test Marks' },
  { key: 'Interview Marks (90)',    label: 'Interview Marks' },
  { key: 'HO Score in Final Admission', label: 'HO Score' },
  ...
  { key: "parent_mobile",           label: "Parent's Mobile" },
  ...
  { key: 'DISTRICT_10',             label: '10th District' },
  { key: '12th SCHOOL NAME',        label: '12th School Name' },
  { key: '12th BOARD',              label: '12th Board' },
  { key: '12th Precentage',         label: '12th Percentage' },
  { key: 'DISTRICT_12',             label: '12th District' },
  { key: 'STATE_12',                label: '12th State' },
  { key: 'JEE MAINS 2024-25 Precentille', label: 'JEE Mains Percentile' },
