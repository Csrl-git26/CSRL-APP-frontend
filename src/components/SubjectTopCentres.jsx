    ...
    <div className="card" style={{ display: 'flex', flexDirection: 'column', minWidth: 0, marginTop: 0, height: '100%' }}>
      <div style={{ position: 'relative', paddingBottom: 8, marginBottom: 14 }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 8, whiteSpace: 'nowrap' }}>
          ...
          <span style={{ fontSize:15, fontWeight:800, letterSpacing:0.2, color: 'rgba(37, 99, 235, 0.85)', textShadow: '0px 1px 1px rgba(255,255,255,0.9), 0px 2px 5px rgba(37,99,235,0.4)' }}>Subject Top 3 CNT</span>
        </div>
