...
# 1. Update WeakTopicCard.jsx
card_code = """// WeakTopicCard.jsx
...
"""
with open('/Users/surya/Desktop/CSRL-APP-frontend/src/components/WeakTopicCard.jsx', 'w') as f:
    f.write(card_code)

# 2. Update StudentWeakTopics.jsx
def patch_student(filepath):
    with open(filepath, 'r') as f:
        content = f.read()

    old_mapping = """              <WeakTopicCard
                key={subject}
                subject={subject}
...
patch_student('/Users/surya/Desktop/CSRL-APP-frontend/src/components/StudentWeakTopics.jsx')

# 3. Update CenterWeakTopics.jsx
def patch_center(filepath):
    with open(filepath, 'r') as f:
        content = f.read()
...
patch_center('/Users/surya/Desktop/CSRL-APP-frontend/src/components/CenterWeakTopics.jsx')
